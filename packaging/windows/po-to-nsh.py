...
KEYS = [
    ...
    ("MYSTR_SEC_PROTO_MAGNET",
        "Register aMule for magnet: links (eD2k-compatible only)"),
    ("MYSTR_SEC_UNINSTALL",
        "Uninstall"),
    ...
    ("MYSTR_DESC_PROTO_ED2K",
        "Registers aMule as the default handler for ed2k:// links. Overwrites any previous handler for the current user."),
    ("MYSTR_DESC_PROTO_MAGNET",
        "Registers aMule as the default handler for magnet: links. aMule only handles eD2k-compatible magnets - BitTorrent magnets will NOT open in aMule. Leave unchecked if you use a BitTorrent client."),
